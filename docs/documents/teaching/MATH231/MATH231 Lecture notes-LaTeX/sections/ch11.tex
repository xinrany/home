...
\begin{figure}[ht]
    \centering
    \resizebox{0.6\textwidth}{!}{\input{images/sequence.tikz}} % Include your TikZ file
    \label{fig:sequence}
...
\begin{figure}[h]
    \centering
    \resizebox{0.6\textwidth}{!}{\input{images/squeeze thm.tikz}} % Include your TikZ file
...
\begin{figure}[h]
    ...
    \quad
    \input{images/right Riemann sum.tikz}} % Include your TikZ file
...
\begin{figure}[H]
        \centering
        \resizebox{\textwidth}{!}{\input{images/Taylor polynomial.tikz}} % Include your TikZ file
